/**
         * 1. Data Dokumen (Mock Database)
         * Jika Anda menggunakan folder lokal di github, ganti 'fileUrl' 
         * dengan path relatif, misalnya: './pdfs/git-cheatsheet.pdf'
         */
        const documents = [
            {
                id: 'git-basics',
                title: 'Git Basics & Commands',
                description: 'Essential Git commands for version control and workflow.',
                fileUrl: 'https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf', // Dummy PDF for demo
                size: '124 KB'
            },
            {
                id: 'js-modern',
